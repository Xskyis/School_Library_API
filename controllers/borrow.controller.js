...
/** function utk mendapatkan semua data borrow */
...
/** function utk memfilter data borrow berdasarkan member */
exports.getBorrowByMember = async (request, response) => {
    ...
    return response.json({
        success: true,
        data: data,
        message: `All borrowing book have been loaded based on member`
    })
}